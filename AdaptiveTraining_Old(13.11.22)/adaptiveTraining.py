...
class scenarioLaunch:
    def __init__(self, scenarioID="", scriptToRun="", sensorPreset="", queueID="lab_08:be:ac:15:01:c3"):
        #### --- CONSTANTS --- ####
        self.MINTIME = 15
    ...
    def runAO(self):
        ...
        self.isRunning = True
        os.system('terminator --geometry=340x130-2700+1000 -T speed -p speed -x rosrun cognata_sdk speed.py')
        print("here")
    ...
    def script_alias_thread_func(self):
        #self.scriptToRun += " > /dev/null" # To remove output
...
if __name__ == '__main__':
    ...
    A = scenarioLaunch(scenarioID, scriptToRun, sensorPreset, 'lab_04:0e:3c:3a:89:d1')
